...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'start', 'error')} required">
	...
	<g:datePicker name="start" precision="day"  value="${projectInstance?.start}"  />
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'due', 'error')}">
	...
	<g:datePicker name="due" precision="day"  value="${projectInstance?.due}" noSelection="${['':'--']}" default="none" />
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'completed', 'error')}">
	...
	<g:datePicker name="completed" precision="day"  value="${projectInstance?.completed}" noSelection="${['':'--']}" default="none"  />
</div>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'paid', 'error')}">
	...
	<g:datePicker name="paid" precision="day"  value="${projectInstance?.paid}" noSelection="${['':'--']}" default="none" />
</div>
